...
const EMOJI_MAP = new Map([
  ...
  ['\u{1F602}', 'smile'], // 😂
  ['\u{1F526}', 'penlight'], // 🔦
  // ジャンプ（2026-08-03追加）。12種のうちここだけ割り当てが抜けていた
  ['\u{2934}', 'jump'], // ⤴
  ['\u{2B06}', 'jump'], // ⬆
  ['\u{1F199}', 'jump'], // 🆙
  ['\u{2191}', 'jump'], // ↑（loyさん指定）
 ...
 */
// ⚠ 2026-08-03: 矢印系（↑ ⤴ 🆙）が範囲の外にあり、拾えていなかった。
//   ブロックごと足すと普通の記号まで巻き込むので、**使う文字だけ**を名指しで加える
const EMOJI_RE = new RegExp(
  '[\\u{1F300}-\\u{1FAFF}\\u{2600}-\\u{27BF}\\u{2B00}-\\u{2BFF}\\u{1F000}-\\u{1F0FF}' +
    '\\u{2191}\\u{2934}\\u{2935}\\u{1F199}]',
  'gu',
);
