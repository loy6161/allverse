 ...
 */
// ⚠ 60 → 2000（2026-08-06）。loyさん「NPCも100近くになると柱になるのやめて」。
//   60を超えたぶんを「人影（箱）」にしていたので、100人あたりから柱が並ぶ見た目になっていた。
//   実機で「ぜんぜん動くよ」とのことなので、**ふつうのアバターで出す数を大幅に上げる**。
//   人影は2000を超えたときの保険としてだけ残す（1万人の負荷テスト用）。
const NPC_AVATAR_MAX = 2000;
let crowd = null;
