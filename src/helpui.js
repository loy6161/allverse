  ...
  const sections = [
    {
      ...
      items: [
        ...
        '<b>立てた本人が、そのイベントの持ち主になります。</b>設定の変更・動画の差し替え・終了は、持ち主と管理者だけができます（他の人のイベントには触れません）',
      ],
    },
    {
      h: 'イベント設定',
      items: [
        '合言葉（空ならパブリック＝誰でも入れる）',
        '定員。<b>いま入っている人数より下げることはできません</b>（上限は外してあります。ただし多いほど通信が増えるので、実際に耐えられるのは1ルーム数十人までです）',
    ...
    {
      h: 'イベントを終了するとき',
      items: ['終了すると、その時いる人も全員退場になります（🚪 パネルの「イベントを終了」）'],
    },
  ];
